...
function ProjectFullTable() {
    const headers = ["Project Name", "Status", "Start Date", "End Date", "Details", "Action"];
    const rows = [
        { projectName: "Project 1", status: "Running", startDate: "2024/02/12", endDate: "2024/02/12", details: "details" },
        { projectName: "Project 2", status: "Running", startDate: "2024/03/01", endDate: "2024/03/05", details: "details" },
        { projectName: "Project 3", status: "Running", startDate: "2024/04/10", endDate: "2024/04/15", details: "details" },
        { projectName: "Project 1", status: "Running", startDate: "2024/02/12", endDate: "2024/02/12", details: "details" },
        { projectName: "Project 2", status: "Running", startDate: "2024/03/01", endDate: "2024/03/05", details: "details" },
        { projectName: "Project 3", status: "Running", startDate: "2024/04/10", endDate: "2024/04/15", details: "details" },
        { projectName: "Project 1", status: "Running", startDate: "2024/02/12", endDate: "2024/02/12", details: "details" },
